### This function will create folders for the provided list in the desired base directory
### This function will edit the base directory index.html adding the list to it where {list2} is
### To use: Paste list, choose nase dir, and name next level
###Levels:
### state->counties->school disctricts->schools->teachers->None

###This program will be used to create the counties for each state then made obsolete 
###                                                         by create.py
...
base_directory = "states/Connecticut"
